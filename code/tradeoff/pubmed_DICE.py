...
parser.add_argument('--save',default='./tradeoff_pubmed_DICE', type=str)
...
with open(os.path.join(args.save, 'pubmed_DICE_modify'), 'a') as file_record:
...
for _ in range(1):
    adds_or_deletes = np.random.choice([0, 1], 10000, p=[0.5, 0.5])
