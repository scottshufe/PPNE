...
parser.add_argument('--save',default='./tradeoff_pubmed_DP', type=str)
...
with open(os.path.join(args.save, 'pubmed_dp_modify'), 'a') as file_record:
    file_record.write('DP modify, now time: {}\n'.format(datetime.now()))
    file_record.write('-------------------------------------------\n')
    file_record.flush()

with open(os.path.join(args.save, 'pubmed_dp_final'), 'a') as file_record_final:
