...
parser.add_argument('--save',default='./pubmed_ppne_flips_100', type=str)
...
with open(os.path.join(args.save, 'ppne_100flips_modify'), 'a') as file_record:
    file_record.write('flips 100, now time: {}\n'.format(datetime.now()))
    file_record.write('-------------------------------------------\n')
    file_record.flush()

with open(os.path.join(args.save, 'ppne_100flips_final'), 'a') as file_record_final:
